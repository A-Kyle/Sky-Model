...
namespace CIE_xyz {
  // dimension 1: central wavelength starting at 380 nm, ending at 780 nm.
  //              increment of wavelength is 5 nm.
  // dimension 2: color matching functions.
  //              index 0: x_bar
  //              index 1: y_bar
  //              index 2: z_bar
  const double xyz[81][3] = {
